...
import Worstmovie from '../../images/Worstmovie.png';
                ...
                <div className="projects-row">
                    {[
                        ...
                        },
                        {
                            ...
                            img: Portfolio,
                            description:
                                'This is this portfolio that is first designed with Adobe XD and later developed with ReactJS.',
                        },
                        {
                            title: 'Worst movie',
                            img: Worstmovie,
                            description:
                                'This is the first project where I used React. It is an application that stores movie titles and their imdb ratings. Then the site presents the worst movie that is stored in the database based on their imdb rating.',
                        },
                        {
                            title: 'Alumntorget',
                            img: Alumntorget,
