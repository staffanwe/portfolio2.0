      ...
      <div className="landingpage">
        <div className="welcome-background">
          <div className="textwrapper">
            <h1 className="welcome">Staffan Westerlund</h1>
          </div>
        ...
        <div className="info-box">
          ...
          <div className="social-links">
            <a href="https://github.com/staffanwe" target="_blank" rel="noopener noreferrer">
              <img src={Github} alt="Github" className="social-link"></img>
            </a>
            <a
            ...
            <a href="https://www.instagram.com/staffanwesterlund/" target="_blank" rel="noopener noreferrer">
              <img src={Instagram} alt="Instagram" className="social-link"></img>
            </a>
          </div>
          <p className="learn-more">Learn more about me and what I do...</p>
